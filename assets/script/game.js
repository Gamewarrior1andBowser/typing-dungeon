...
function updateScores() {
  ...
  const scorestorage = 'gamescores';
  let list = JSON.parse(localStorage.getItem(scorestorage)) || [];
  ...
  if (list[0]) one.innerText = `Top1: Score: ${list[0][0]} <---> Accuracy: ${list[0][1]}%`;
  if (list[1]) two.innerText = `Top2: Score: ${list[1][0]} <---> Accuracy: ${list[1][1]}%`;
  if (list[2]) three.innerText = `Top3: Score: ${list[2][0]} <---> Accuracy: ${list[2][1]}%`;
  if (list[3]) four.innerText = `Top4: Score: ${list[3][0]} <---> Accuracy: ${list[3][1]}%`;
  if (list[4]) five.innerText = `Top5: Score: ${list[4][0]} <---> Accuracy: ${list[4][1]}%`;
  if (list[5]) six.innerText = `Top6: Score: ${list[5][0]} <---> Accuracy: ${list[5][1]}%`;
  if (list[6]) seven.innerText = `Top7: Score: ${list[6][0]} <---> Accuracy: ${list[6][1]}%`;
  if (list[7]) eight.innerText = `Top8: Score: ${list[7][0]} <---> Accuracy: ${list[7][1]}%`;
  if (list[8]) nine.innerText = `Top9: Score: ${list[8][0]} <---> Accuracy: ${list[8][1]}%`;
  localStorage.setItem(scorestorage, JSON.stringify(list));
}
